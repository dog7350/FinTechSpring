...
public class MailService {
	...
	public void send3(String userId, HttpSession session, String email) {
		...
		String body = "<h2>인증 해주세요</h2>"
				+ "<a href='http://localhost:8888/root/check?userId=" + userId +"&userKey=" + userKey + "'>인증하기</a>";
	...
	private String rand() {
		...
		while (str.length() <= 20) {
			...
			if ((num >= 48 && num <= 57) || (num >= 65 && num <= 30) || (num >= 97 && num <= 122)) str += (char) num;
		}
